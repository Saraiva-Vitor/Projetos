...
double resistor(double x, vector<double>param){
	return (exp(-(0.005*x))*(cos(sqrt(2000-(0.01*(pow(x,2))))*0.05))+
         (((x/10)*(1/sqrt(2000-(0.01*(pow(x,2))))))*exp(-(0.005*x))*(sin(sqrt(2000-(0.01*(pow(x,2))))*0.05)))-0.01);

}
double indutor(double x, vector<double> param){
	return (exp(-(7/x))*(cos(sqrt((10000/x)-(19600/(pow(x,2))))*0.05))+
         (((280/2*x)*(1/sqrt((10000/x)-(19600/(pow(x,2))))))*exp(-(7/x))*(sin(sqrt((10000/x)-(19600/(pow(x,2))))*0.05)))-0.01);
}
void print_data(double (*func)(double, vector<double>), vector<double>parametros, int k,
                double x, double inter_a, double inter_b, double mod_ab){
