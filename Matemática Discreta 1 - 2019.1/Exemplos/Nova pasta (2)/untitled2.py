...
def adicionar_cadastro():
    ...
    juros = etJuros.get()
    cursor.execute("""
        INSERT INTO cadastros (N, valor, parcelas, juros) VALUES (?, ?, ?, ?)""", (N, valor, parcelas, juros))
    conn.commit()
    lstCadastros.insert(END, (N, valor, parcelas, juros))
...
def carregarvalores():   
    ...
    for row in cursor.execute("""SELECT * FROM cadastros WHERE N=?""", (N_cadastro,)):
        etValor.insert(10, row[1])
        etParcelas.insert(10, row[2])
        etJuros.insert(10, row[3])
...
def alterarvalores():
    ...
    def mudar_valores():
        ...
        if (novo_valor=="" or nova_parcela=="" or novo_juros==""):
    ...
    lblNovaValor.grid(row=2, column=0)
    etNovoValor.grid(row=2, column=1)
    lblNovaParcela.grid(row=3, column=0)
    etNovaParcela.grid(row=3, column=1)
    lblNovoJuros.grid(row=4, column=0)
    etNovoJuros.grid(row=4, column=1)
    btnMudarValor.grid(row=5, column=1)
...
def sac():
    ...
    if (int(n)>40):
        ...
        newwin['borderwidth'] = 10
        newwin['relief'] = 'solid'
        canvas = Canvas(newwin, borderwidth=0, background="#ffffff")
        newwinframe = Frame(newwin, background="#ffffff")
        vsb = Scrollbar(newwin, orient="vertical", command=canvas.yview)
        canvas.configure(yscrollcommand=vsb.set)
        vsb.pack(side="right", fill="y")
        canvas.pack(side="left", fill="both", expand=True)
        canvas.create_window((4,4), window=newwinframe, anchor="nw")
        newwinframe.bind("<Configure>", lambda event, canvas=canvas: onFrameConfigure(canvas))
        v = float(v)
        n = int(n)
        i = float(i)
        ...
        lb = Label(newwin, text="Parcela  ",font ="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid")
        lb1 = Label(newwin, text="Valor da Prestação  ",font ="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid")
        lb2 = Label(newwin, text="Amortização  ",font ="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid")
        lb3 = Label(newwin, text="Juros  ",font ="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid")
        lb4 = Label(newwin, text="Saldo Devedor  ",font ="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid")
        Label(newwin,text="R$ "+str(round(v,r)),font ="Arial 10",fg="red",borderwidth="1",relief="solid").grid(row=3,column=4)
        Label(newwin,text="0",font="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid").grid(row=3,column=0)
        i = i/100
        sd=v
        a=v/n
        sj=0
        ...
        for c in range(0, n):
            ...
            if sd<=0:
                sd=0
            Label(newwin,text=str(c+1),font="Arial 10 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid").grid(row=c+4,column=0)
            Label(newwin,text="R$ "+str(round(pmt,r)),font="Arial 10",fg="darkgreen",borderwidth="1",relief="solid").grid(row=c+4,column=1)
            Label(newwin,text="R$ "+str(round(a,r)),font="Arial 10",fg="darkgreen",borderwidth="1",relief="solid").grid(row=c+4,column=2)
            Label(newwin,text="R$ "+str(round(j,r)),font="Arial 10",fg="darkgreen",borderwidth="1",relief="solid").grid(row=c+4,column=3)
            Label(newwin,text="R$ "+str(round(sd,r)),font="Arial 10",fg="red",borderwidth="1",relief="solid").grid(row=c+4,column=4)
            sj=round(sj+j,r)
            sp=round(sp+pmt,r)
            sa=round(sa+a,r)
            if sa>v or sa<v:
                sa=v
        Label(newwin,text="<== Totais",font="Arial 12 bold",fg="blue",background='darkgrey',borderwidth="1",relief="solid").grid(row=n+5,column=4)
        Label(newwin,text="R$ "+str(sj),font="Arial 10",fg="blue",borderwidth="1",relief="solid").grid(row=n+5,column=3)
        Label(newwin,text="R$ "+str(sa),font="Arial 10",fg="blue",borderwidth="1",relief="solid").grid(row=n+5,column=2)
        Label(newwin,text="R$ "+str(sp),font="Arial 10",fg="blue",borderwidth="1",relief="solid").grid(row=n+5,column=1)
...
lblNomeValor = Label(principal, text="Nº / Valor / Parcelas / Juros",font="Arial 10 bold",background='white')
...
etValor.grid(row=3, column=1)
lblParcelas.grid(row=4,column=0)
lblparcelasobs.grid(row=5,column=1)
etParcelas.grid(row=4,column=1)
